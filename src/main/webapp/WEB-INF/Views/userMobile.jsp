  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-info">
        ...
        <div class="panel-footer"><a href="/user/addToCart/${productList[count.index].pId}" class="btn btn-sm btn-hover btn-info cartButton">Add to Cart</a></div>
      </div>
    </div>
    ...
    <div class="col-sm-4">
      <div class="panel panel-danger">
        ...
        <div class="panel-footer"><a href="/user/addToCart/${productList[count.index+1].pId}" class="btn btn-sm btn-hover btn-info cartButton">Add to Cart</a></div>
      </div>
    </div>
    </c:if>
    ...
    <div class="col-sm-4">
      <div class="panel panel-success">
        ...
        <div class="panel-body"><img src="http://placehold.it/150x80?text=IMAGE" class="img-responsive" style="width:100%" alt="Image"></div>
        <div class="panel-footer"><a href="/user/addToCart/${productList[count.index+2].pId}" class="btn btn-sm btn-hover btn-info cartButton">Add to Cart</a></div>
      </div>
    </div>
    </c:if>
  </div>
