...
<div class="col-md-2 col-xs-2">Category Name: <form:input path="cName" type="text" name="cName" /></div>
Error:<form:errors path="cName" ></form:errors>
<div class="col-md-2 col-xs-2">Category Id: <form:input path="cId" type="number" name="cId"  readonly="true"/></div>
</div>
<div class="row">
...
<div class="col-md-2 col-xs-2">Category Name: <form:input path="cName" type="text" name="cName"/></div>
Error:<form:errors path="cName"></form:errors>
<div class="col-md-2 col-xs-2" style="display: none">Category Id: <form:input path="cId" type="number" name="cId" value="0"/></div>
</div>
<div class="row">
